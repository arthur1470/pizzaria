	...
	<body>
		...
		<form class="container corpotop" action="alterarPizza" method="POST">
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" name="precoMedia" value="${pizza.precoMedia}" class="form-control" id="precoMedia" placeholder="Preço pizza média" onkeypress="mascara(this, '##.##')" maxlength="5">
		  </div>
		  <div class="form-group">
		    <label for="precoGrande">Preço Grande R$</label>
		    <input type="text" name="precoGrande" value="${pizza.precoGrande}" class="form-control" id="precoGrande" placeholder="Preço pizza grande" onkeypress="mascara(this, '##.##')" maxlength="5">
		  </div>
		  <div class="form-group">
		    <label for="precoFamilia">Preço Tamanho Familia R$</label>
		    <input type="text" name="precoFamilia" value="${pizza.precoFamilia}" class="form-control" id="precoFamilia" placeholder="Preço pizza tamanho familia" onkeypress="mascara(this, '##.##')" maxlength="5">
		  </div>
